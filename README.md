...
This app is designed to make **zero external network requests**:

- **No third-party fonts** — uses system font stacks only.
- **No analytics or tracking** — no Google Analytics, no pixels, nothing.
- **No CDN dependencies** — all code is self-contained in `index.html`.
...
All paths in the manifest, service worker, and HTML are relative (`./`),
